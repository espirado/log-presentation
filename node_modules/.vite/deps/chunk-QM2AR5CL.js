...
// node_modules/mermaid/dist/index-5e3196ce.js
function m3(e) {
  var t = {
    options: {
...
var at = (e, t) => {
  ...
  const n = Jn(), r = e.insert("g").attr("class", "cluster" + (t.class ? " " + t.class : "")).attr("id", t.id), i = r.insert("rect", ":first-child"), a2 = Da(n.flowchart.htmlLabels), d = r.insert("g").attr("class", "cluster-label"), u = t.labelType === "markdown" ? Ur(d, t.labelText, { style: t.labelStyle, useHtmlLabels: a2 }) : d.node().appendChild(R(t.labelText, t.labelStyle, void 0, true));
  let f = u.getBBox();
...
//# sourceMappingURL=chunk-QM2AR5CL.js.map
