...
// node_modules/mermaid/dist/timeline-definition-1d5f75ec.js
var K = function() {
...
var it = () => P_;
var rt = function() {
  Q.length = 0, G.length = 0, R = "", F.length = 0, M_();
};
var at = function(n) {
  R = n, Q.push(n);
};
...
var Rt = function(n, t, e, a) {
  ...
  L.debug("bounds", V), v && u.append("text").text(v).attr("x", V.width / 2 - c).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), h = x ? i + r + 150 : r + 100, u.append("g").attr("class", "lineWrapper").append("line").attr("x1", c).attr("y1", h).attr("x2", V.width + 3 * c).attr("y2", h).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), F_(
    void 0,
    u,
...
//# sourceMappingURL=timeline-definition-1d5f75ec-ARH6CON3.js.map
