...
// node_modules/mermaid/dist/xychartDiagram-024e42d6.js
function Jt(e, t2, i) {
...
function Ai() {
  ...
  return y.title = R_(), ci2.build(Y, y, H, Tt);
}
function wi() {
  return H;
}
...
var Ci = function() {
  M_(), X = 0, Y = Pt(), y = Lt(), H = Dt(), at = H.plotColorPalette.split(",").map((e) => e.trim()), G = false, rt = false;
};
var _i = {
  getDrawableElem: Ai,
  clear: Ci,
...
` + e);
  const _ = Y_(t2), A = _.append("g").attr("class", "main"), m = A.append("rect").attr("width", c.width).attr("height", c.height).attr("class", "background");
...
//# sourceMappingURL=xychartDiagram-024e42d6-6I2SWQK2.js.map
