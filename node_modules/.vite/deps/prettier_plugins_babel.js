...
var Vs = (a, t, e, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let i of Us(t))
      !js.call(a, i) && i !== e && Re(a, i, { get: () => t[i], enumerable: !(s = Rs(t, i)) || s.enumerable });
  return a;
};
var It = (a, t, e) => (e = a != null ? Bs(_s(a)) : {}, Vs(t || !a || !a.__esModule ? Re(e, "default", { value: a, enumerable: true }) : e, a));
var gt = $s((me) => {
  "use strict";
  ...
  var We = class extends Je {
    ...
    finalizeComment(t) {
      ...
      if (t.leadingNode !== null || t.trailingNode !== null)
        t.leadingNode !== null && Gt(t.leadingNode, e), t.trailingNode !== null && Ai(t.trailingNode, e);
      else {
...
`);
  ...
  var Ni = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), M = class {
    ...
    skipLineComment(t) {
      ...
      if (this.state.pos < this.length)
        for (; !Y(i) && ++this.state.pos < this.length; )
    ...
    readToken_interpreter() {
      ...
      for (this.state.pos += 1; !Y(t) && ++this.state.pos < this.length; )
  ...
  var Ui = /\*?\s*@((?:no)?flow)\b/, _i = (a) => class extends a {
      ...
      switch (this.state.type) {
        ...
        case 10: {
          ...
          if (this.next(), !this.match(11) && !this.match(21))
            if (C(this.state.type) || this.match(78)) {
    ...
    parseExpressionStatement(e, s, i) {
      if (s.type === "Identifier") {
        if (s.name === "declare") {
          if (this.match(80) || C(this.state.type) || this.match(68) || this.match(74) || this.match(82))
  ...
  function X(a) {
    ...
    if (a.type === "JSXMemberExpression")
      return X(a.object) + "." + X(a.property);
  ...
  var ji = (a) => class extends a {
    jsxReadToken() {
      ...
      for (; ; ) {
        if (this.state.pos >= this.length)
          throw this.raise(H.UnterminatedJsxContent, this.state.startLoc);
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
    ...
    jsxParseElementAt(e) {
      ...
      if (V(r) ? (s.openingFragment = r, s.closingFragment = n) : (s.openingElement = r, s.closingElement = n), s.children = i, this.match(47))
        throw this.raise(H.UnwrappedAdjacentJSXElements, this.state.startLoc);
    ...
    updateContext(e) {
      ...
      if (i === 56 && e === 143)
        ...
        this.state.canStartJSXElement = ii(i);
    }
  }, rt = class extends ue {
    constructor(...t) {
  ...
  var qi = (a) => class extends a {
    ...
    tsParseModifier(e, s) {
      if (!C(this.state.type) && this.state.type !== 58 && this.state.type !== 75)
        return;
      let i = this.state.value;
      if (e.includes(i)) {
    ...
    tsParseDeclaration(e, s, i, r) {
      switch (s) {
        case "abstract":
          if (this.tsCheckLineTerminator(i) && (this.match(80) || C(this.state.type)))
        ...
        case "module":
          ...
          break;
        case "namespace":
          if (this.tsCheckLineTerminator(i) && C(this.state.type))
    ...
    parseVarStatement(e, s, i = false) {
      ...
      for (let { id: o, init: h } of n.declarations)
        h && (s !== "const" || o.typeAnnotation ? this.raise(y.InitializerNotAllowedInAmbientContext, h) : Hi(h, this.hasPlugin("estree")) || this.raise(y.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, h));
      return n;
    }
    ...
    parseExprOp(t, e, s) {
      ...
      if (ni(i) && (this.prodParam.hasIn || !this.match(58))) {
        ...
        if (r > s) {
          ...
          if (h && (r = we(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
...
`), cooked: r === null ? null : r.slice(1, l) }, o.tail = h, this.next();
    ...
    parseObjectProperty(t, e, s, i) {
      ...
      if (!t.computed && t.key.type === "Identifier") {
        if (this.checkReservedWord(t.key.name, t.key.loc.start, true, false), s)
          t.value = this.parseMaybeDefault(e, _(t.key));
  ...
  var ht = class extends ot {
    ...
    startsUsingForOf() {
      ...
      if (t === 102 && !e)
        return false;
      if (C(t) && !this.hasFollowingLineBreak())
    ...
    isExportDefaultSpecifier() {
      ...
      if (this.input.charCodeAt(e) === 44 || C(this.state.type) && s)
        return true;
      if (this.match(65) && s) {
...
var vs = [$(["jsx"])];
var Es = ie({ optionsCombinations: vs });
var Is = ie({ optionsCombinations: [$(["jsx", "typescript"]), $(["typescript"])] });
var Ns = ie({ isExpression: true, optionsCombinations: [$(["jsx"])] });
var ks = ie({ isExpression: true, optionsCombinations: [$(["typescript"])] });
var Ls = ie({ optionsCombinations: [$(["jsx", ["flow", { all: true }], "flowComments"])] });
var qr = ie({ optionsCombinations: vs.map((a) => $(["estree"], a)) });
var Ds = { babel: Es, "babel-flow": Ls, "babel-ts": Is, __js_expression: Ns, __ts_expression: ks, __vue_expression: Ns, __vue_ts_expression: ks, __vue_event_binding: Es, __vue_ts_event_binding: Is, __babel_estree: qr };
var Ms = It(gt(), 1);
function Os(a = {}) {
...
var Ct = Os();
var Kr = { json: W({ parse: Ct, hasPragma() {
  return true;
} }), json5: W(Ct), jsonc: W(Ct), "json-stringify": W({ parse: Os({ allowComments: false }), astFormat: "estree-json" }) };
var Fs = Kr;
var Hr = { ...Ds, ...Fs };
var Cn = Et;
export {
