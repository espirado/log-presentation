...
// node_modules/mermaid/dist/styles-f32eefb3.js
var Ve = function() {
...
var Xe = class {
  ...
  getDisplayDetails() {
    let i = this.visibility + S1(this.id);
    this.memberType === "method" && (i += `(${S1(this.parameters.trim())})`, this.returnType && (i += " : " + S1(this.returnType))), i = i.trim();
...
var _t = function(e, i, r) {
  ...
  e.split(",").forEach(function(o) {
    let A = o;
    o[0].match(/\d/) && (A = pe + A), p[A] !== void 0 && (p[A].link = ni.formatUrl(i, l), l.securityLevel === "sandbox" ? p[A].linkTarget = "_top" : typeof r == "string" ? p[A].linkTarget = V(r) : p[A].linkTarget = "_blank");
  }), Me(e, "clickable");
};
...
//# sourceMappingURL=chunk-56XCTST4.js.map
