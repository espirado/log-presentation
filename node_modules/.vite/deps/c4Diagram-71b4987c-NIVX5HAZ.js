...
// node_modules/mermaid/dist/c4Diagram-71b4987c.js
var Yt = function() {
...
function I(e, t, r, o, l2) {
  if (!t[e].width)
    if (r)
      t[e].text = R0(t[e].text, l2, o), t[e].textLines = t[e].text.split(Rn.lineBreakRegex).length, t[e].width = l2, t[e].height = q0(t[e].text, o);
    else {
      ...
      for (const s of n)
        t[e].width = Math.max(
          ar(s, o),
          t[e].width
        ), a = q0(s, o), t[e].height = t[e].height + a;
    }
}
...
//# sourceMappingURL=c4Diagram-71b4987c-NIVX5HAZ.js.map
