...
// node_modules/mermaid/dist/sankeyDiagram-21c8b3a4.js
var tt = function() {
...
var re = function(t, n, s, a) {
  const { securityLevel: u, sankey: y } = Jn(), p = E1.sankey;
  let m;
  u === "sandbox" && (m = Tt("#i" + n));
...
${x}${Math.round(w * 100) / 100}${E}` : g;
  ...
  $.append("path").attr("d", ie()).attr("stroke", I).attr("stroke-width", (g) => Math.max(1, g.width)), F_(void 0, o, 0, b);
};
var oe = {
  draw: re
};
...
//# sourceMappingURL=sankeyDiagram-21c8b3a4-R6UNCWLS.js.map
