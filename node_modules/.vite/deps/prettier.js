...
var require_standalone = __commonJS({
  "node_modules/prettier/standalone.js"(exports, module) {
    (function(t) {
      ...
      var fr = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), Bt = (e, t) => {
        for (var r in t)
          Me(e, r, { get: t[r], enumerable: true });
      }, dr = (e, t, r, n) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let u of vu(t))
            !wu.call(e, u) && u !== r && Me(e, u, { get: () => t[u], enumerable: !(n = Au(t, u)) || n.enumerable });
        return e;
      };
      var Ue = (e, t, r) => (r = e != null ? yu(Bu(e)) : {}, dr(t || !e || !e.__esModule ? Me(r, "default", { value: e, enumerable: true }) : r, e)), _u = (e) => dr(Me({}, "__esModule", { value: true }), e);
      var xu = (e, t, r) => t.has(e) || cr("Cannot " + r);
      var pr = (e, t, r) => t.has(e) ? cr("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r);
...
${f}`), f;
      ...
      var lo = {};
      Bt(lo, { __debug: () => Do, check: () => so, doc: () => ar, format: () => gu, formatWithCursor: () => Cu, getSupportInfo: () => ao, util: () => lr, version: () => lu });
      var bu = (e, t, r, n) => {
        if (!(e && t == null))
      ...
      M.prototype = { diff: function(t, r) {
        ...
        if (c[0].oldPos + 1 >= D && F + 1 >= a)
          return s(Fr(o, c[0].lastComponent, r, t, o.useLongestToken));
        var m = -1 / 0, h = 1 / 0;
        function C() {
          for (var E = Math.max(m, -l); E <= Math.min(h, l); E += 2) {
            ...
            if (!$e || X && j.oldPos < b.oldPos ? g = o.addToPath(b, true, false, 0, u) : g = o.addToPath(j, false, true, 1, u), F = o.extractCommon(g, r, t, E, u), g.oldPos + 1 >= D && F + 1 >= a)
              return s(Fr(o, g.lastComponent, r, t, o.useLongestToken));
      ...
      var ze = "a-zA-Z0-9_\\u{C0}-\\u{FF}\\u{D8}-\\u{F6}\\u{F8}-\\u{2C6}\\u{2C8}-\\u{2D7}\\u{2DE}-\\u{2FF}\\u{1E00}-\\u{1EFF}", Ou = new RegExp("[".concat(ze, "]+|\\s+|[^").concat(ze, "]"), "ug"), Ke = new M();
      ...
      function Cr(e, t, r, n) {
        if (t && r) {
          ...
          if (n) {
            var D = hr(i, s);
            n.value = wt(n.value, s, D), t.value = Ve(t.value, D), r.value = Ve(r.value, D);
          }
        } else if (r)
          ...
          var c = hr(we(l, d), f);
          t.value = Ve(t.value, c), n.value = wt(n.value, l, c), e.value = _t(e.value, l, l.slice(0, l.length - c.length));
        } else if (n) {
...
`);
      ...
      var U = "string", H = "array", V = "cursor", T = "indent", k = "align", L = "trim", B = "group", N = "fill", w = "if-break", P = "indent-if-break", I = "line-suffix", R = "line-suffix-boundary", A = "line", O = "label", _ = "break-parent", Je = /* @__PURE__ */ new Set([V, T, k, L, B, N, w, P, I, R, A, O, _]);
      function Lu(e) {
        if (typeof e == "string")
          return U;
        if (Array.isArray(e))
...
Expected it to be ${n}.`;
      ...
      function Tt(e, t = {}) {
        return G(e), qe(t.expandedStates, true), { type: B, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates };
      }
      function wr(e) {
      ...
      var Tr = { type: R }, Fe = { type: _ }, kr = { type: L }, Oe = { type: A, hard: true }, kt = { type: A, hard: true, literal: true }, Xe = { type: A }, Lr = { type: A, soft: true }, K = [Oe, Fe], Qe = [kt, Fe], Z = { type: V };
      function Se(e, t) {
        G(e), qe(t);
        let r = [];
      ...
      function Ir(e) {
        ...
        function n(i, o, s) {
          ...
          if (i.type === _)
            return ((D = s == null ? void 0 : s[o - 1]) == null ? void 0 : D.type) === A && s[o - 1].hard ? void 0 : "breakParent";
          if (i.type === L)
            return "trim";
          if (i.type === T)
      ...
      function Wu(e) {
        if (e.type === B && e.break || e.type === A && e.hard || e.type === _)
          return true;
      }
      function Mr(e) {
        return et(e, Wu, false);
      }
      function Wr(e) {
        if (e.length > 0) {
          let t = y(false, e, -1);
      ...
      function $r(e) {
        for (e = [...e]; e.length >= 2 && y(false, e, -2).type === A && y(false, e, -1).type === _; )
          e.length -= 2;
        if (e.length > 0) {
...
`, u) : c;
            ...
            case N: {
              ...
              if (C === 0)
                break;
              let v = h[m + 0], E = h[m + 1], g = { ind: f, mode: J, doc: v }, j = { ind: f, mode: Y, doc: v }, b = rt(g, [], F, D.length > 0, r, true);
              if (C === 1) {
                b ? o.push(g) : o.push(j);
                break;
              }
              ...
              let $e = h[m + 2], vt = { ind: f, mode: d, doc: { ...c, [Lt]: m + 2 } };
              rt({ ind: f, mode: J, doc: [v, E, $e] }, [], F, D.length > 0, r, true) ? o.push(vt, X, g) : b ? o.push(vt, ae, g) : o.push(vt, ae, j);
              break;
            }
            case w:
            case P: {
        ...
        if (p !== -1) {
          ...
          if (f === -1)
            return { formatted: s.filter((m) => m !== he).join("") };
      ...
      var te, Yt, nt, Rt = class {
        ...
        get ancestors() {
          return [...pe(this, te, nt).call(this)];
        }
        getName() {
        ...
        findAncestor(t) {
          for (let r of pe(this, te, nt).call(this))
            if (t(r))
              return r;
        }
        hasAncestor(t) {
      ...
      var en = ye(/\s/u), S = ye(" 	"), ut = ye(",; 	"), it = ye(/[^\n\r]/u);
      function qu(e, t, r) {
...
` || u === "\r" || u === "\u2028" || u === "\u2029")
      ...
      function ot(e, t) {
        ...
        if (!n)
          return [];
        let s = ((r == null ? void 0 : r(e, t)) ?? [...ge(e, { getVisitorKeys: q(u) })]).flatMap((a) => n(a) ? [a] : ot(a, t));
        return s.sort((a, D) => i(a) - i(D) || o(a) - o(D)), Wt.set(e, s), s;
      }
      function nn(e, t, r, n) {
        let { locStart: u, locEnd: i } = r, o = u(t), s = i(t), a = ot(e, r), D, l, p = 0, f = a.length;
        for (; p < f; ) {
      ...
      function un(e, t) {
        let { comments: r } = e;
        if (delete e.comments, !jt(r) || !t.printer.canAttachComment)
          return;
        ...
        for (let [d, c] of f.entries()) {
          ...
          let b;
          if (o ? b = [c] : (F.enclosingNode = h, F.precedingNode = m, F.followingNode = C, b = [F, v, E, g, j]), ri(v, E, f, d))
      ...
      function ii(e, t) {
        ...
        if ((l = u.isBlockComment) == null ? void 0 : l.call(u, r)) {
          let p = $(i, s(r)) ? $(i, o(r), { backwards: true }) ? K : Xe : " ";
          n.push(p);
        } else
          n.push(K);
        let D = W(i, S(i, s(r)));
...
in order for it to be formatted.`, cliCategory: "Other" }, tabWidth: { type: "int", category: "Global", default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: 1 / 0, step: 1 } }, useTabs: { category: "Global", type: "boolean", default: false, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { category: "Global", type: "choice", default: "auto", description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
      function st({ plugins: e = [], showDeprecated: t = false } = {}) {
        ...
        for (let u of li(Object.assign({}, ...e.map(({ options: i }) => i), cn)))
          !t && u.deprecated || (Array.isArray(u.choices) && (t || (u.choices = u.choices.filter((i) => !i.deprecated)), u.name === "parser" && (u.choices = [...u.choices, ...Di(u.choices, r, e)])), u.pluginDefaults = Object.fromEntries(e.filter((i) => {
            var o;
      ...
      var Ut = Ue(at(), 1), mn = (e, t, { descriptor: r }) => {
...
`)), yn(i, r.loggerPrintWidth);
      ...
      function En(e, t, r, n) {
        return [`Invalid ${ce.default.red(n.key(e))} value.`, `Expected ${ce.default.blue(r)},`, `but received ${t === Dt ? ce.default.gray("nothing") : ce.default.red(n.value(t))}.`].join(" ");
      }
...
`, 1)[0].length);
      ...
      function zt(e, t) {
        ...
        let o, s, a, D, l = 0, p = 0;
        for (; l < n; )
          An[l] = e.charCodeAt(i + l), Vt[l] = ++l;
        for (; p < u; )
          for (o = t.charCodeAt(i + p), a = p++, s = p, l = 0; l < n; l++)
            D = o === An[l] ? a : a + 1, a = Vt[l], s = Vt[l] = a > s ? D > s ? s + 1 : D : D > a ? a + 1 : D;
        return s;
      }
      var lt = (e, t, { descriptor: r, logger: n, schemas: u }) => {
      ...
      function Fi(e, t) {
        ...
        for (let u of pi)
          u in t && (n[u] = mi(t[u], r, x.prototype[u].length));
        return n;
      }
      var x = class {
        static create(t) {
      ...
      var Ct = class {
        constructor(t, r) {
          ...
          } }, loggerPrintWidth: u, schemas: wn(t, "name"), normalizeDefaultResult: Kt, normalizeExpectedResult: Jt, normalizeDeprecatedResult: Xt, normalizeForwardResult: Ft, normalizeRedirectResult: Qt, normalizeValidateResult: qt }, this._unknownHandler = o, this._invalidHandler = Sn(s), this._deprecatedHandler = a, this._identifyMissing = (d, c) => !(d in c) || D(d, c), this._identifyRequired = l, this._preprocess = p, this._postprocess = f, this.cleanHistory();
        }
        cleanHistory() {
        ...
        _applyNormalization(t, r) {
          ...
          for (let o of u) {
            ...
            Ft(s.forward(a, this._utils), a).forEach(D);
        ...
        _applyRequiredCheck(t) {
          for (let r of Object.keys(this._utils.schemas))
            if (this._identifyMissing(r, t) && this._identifyRequired(r))
              throw this._invalidHandler(r, Dt, this._utils);
        }
      ...
      function Ci(e, t, { logger: r = false, isCLI: n = false, passThrough: u = false, FlagSchema: i, descriptor: o } = {}) {
        ...
        let s = u ? Array.isArray(u) ? (f, d) => u.includes(f) ? { [f]: d } : void 0 : (f, d) => ({ [f]: d }) : (f, d, c) => {
          let { _: F, ...m } = c.schemas;
          return lt(f, d, { ...c, schemas: m });
        }, a = gi(t, { isCLI: n, FlagSchema: i }), D = new Ct(a, { logger: r, unknown: s, descriptor: o }), l = r !== false;
      ...
      function gi(e, { isCLI: t, FlagSchema: r }) {
        let n = [];
        t && n.push(ft.create({ name: "_" }));
        for (let u of e)
          n.push(yi(u, { isCLI: t, optionInfos: e, FlagSchema: r })), u.alias && t && n.push(ct.create({ name: u.alias, sourceName: u.name }));
        return n;
      }
      function yi(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
        ...
        switch (e.type) {
          case "int":
            o = Et, t && (i.preprocess = Number);
            break;
          case "string":
            o = je;
            break;
          case "choice":
            o = mt, i.choices = e.choices.map((a) => a != null && a.redirect ? { ...a, redirect: { to: { key: e.name, value: a.redirect } } } : a);
            break;
          case "boolean":
            o = pt;
            break;
        ...
        return e.array ? dt.create({ ...t ? { preprocess: (a) => Array.isArray(a) ? a : [a] } : {}, ...s, valueSchema: o.create(i) }) : o.create({ ...i, ...s });
      }
      var In = Ci;
      var Ai = (e, t, r) => {
        if (!(e && t == null)) {
      ...
      function gt({ plugins: e, parser: t }) {
        let r = tr(e, t);
        return rr(r, t);
      }
      function rr(e, t) {
      ...
      async function vi(e, t = {}) {
        ...
        if (!r.parser)
          if (r.filepath) {
            if (r.parser = dn(r, { physicalFile: r.filepath }), !r.parser)
        ...
        let n = st({ plugins: e.plugins, showDeprecated: true }).options, u = { ...jn, ...Object.fromEntries(n.filter((f) => f.default !== void 0).map((f) => [f.name, f.default])) }, i = tr(r.plugins, r.parser), o = await rr(i, r.parser);
      ...
      async function xi(e, t) {
        let r = await gt(t), n = r.preprocess ? r.preprocess(e, t) : e;
        t.originalText = n;
        let u;
        try {
...
` + n, e.codeFrame = n, e;
      ...
      async function He(e, t) {
        ...
        if (Dn(t), t.nodeAfterCursor && !t.nodeBeforeCursor)
          return [Z, o];
      ...
      function Si(e, t) {
        ...
        for (let d of Qr(e, { getVisitorKeys: i, filter: o }))
          a.push(d), s = d;
        if (Zr(s, { getVisitorKeys: i }))
          return { cursorNode: s };
      ...
      function Qn(e, t, r) {
        ...
        if (Li(t)) {
          ...
          ({ startNode: p, endNode: f } = Ii(D, l, t));
...
`);
      ...
      async function sr(e, t) {
        ...
        if (u.rangeStart >= u.rangeEnd && n !== "" || u.requirePragma && !await tu(n, u))
      ...
      var ve = Ui;
      function Vi(e, t) {
        return t === false ? false : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? it(e, t) : t;
      }
      var Be = Vi;
      function zi(e, t) {
        let r = null, n = t;
        for (; n !== r; )
          r = n, n = S(e, n), n = ve(e, n), n = Be(e, n), n = W(e, n);
        return n;
      }
      var We = zi;
      function Gi(e, t) {
...
`);
      ...
      var At = "'", pu = '"';
      function Xi(e, t) {
        let r = t === true || t === At ? At : pu, n = r === At ? pu : At, u = 0, i = 0;
        for (let o of e)
          o === r ? u++ : o === n && i++;
        return u > i ? n : r;
      }
...
`)
      ...
      function oo(e, t) {
        return arguments.length === 2 || typeof t == "number" ? yt(e, t) : io(...arguments);
      }
      function de(e, t = 1) {
        return async (...r) => {
      ...
      var ao = de(st, 0), Do = { parse: de(iu), formatAST: de(ou), formatDoc: de(su), printToDoc: de(au), printDocToString: de(Du) };
      return _u(lo);
    });
  }
});
